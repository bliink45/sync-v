...
RegisterNetEvent('SyncV:SessionManager.saveClientCurrentLocation::request')
AddEventHandler('SyncV:SessionManager.saveClientCurrentLocation::request', function()
    TriggerServerEvent('SyncV:SessionManager.savePlayerCurrentLocation', getCurrentLocation())
end)
